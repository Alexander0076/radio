...
<link rel="stylesheet" href="<?php echo constant('URL') ?>resources/resources/css/radio.css">
...
<section class="breadcumb-area bg-img bg-overlay" style="background-image: url(<?php echo constant('URL') ?>resources/resources/img/bg-img/breadcumb3.jpg);">
    ...
    <br><br><br><br><br><br>
<!-- ##### Buy Now Area Start ##### -->
<section class="oneMusic-buy-now-area has-fluid bg-gray ">
...
<!-- <script src="<?php echo constant('URL') ?>resources/resources/js/radio.js"></script> -->
...
tracks: [
    {
        artist: "ONE SOUND",
        song: "Somos tu mejor opción",
        url: "<?php echo constant('URL') ?>resources/resources/audio/mix-the-weekend.mp3"
    }
],
