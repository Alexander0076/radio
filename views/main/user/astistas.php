...
<body>
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#"><?php echo "$_SESSION[NameUsuIni]"; ?></a>
                                                <ul class="dropdown">
                                                <li><a href="#"><img src="<?php echo constant('URL') ?>resources/recursos/img/core-img/logo.png" alt=""></a></li>
    ...
    <section class="featured-artist-area section-padding-100 bg-img bg-overlay bg-fixed" style="background-image: url(<?php echo constant('URL') ?>resources/recursos/img/bg-img/bg-4.jpg);">
        <div class="container">
    ...
    <!-- ##### Contact Area Start ##### -->
    <section class="contact-area section-padding-100 bg-img bg-overlay bg-fixed has-bg-img" style="background-image: url(<?php echo constant('URL') ?>resources/recursos/img/bg-img/bg-2.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
